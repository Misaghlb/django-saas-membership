...
)  # (misaghestan/config/settings/base.py - 3 = misaghestan/)
APPS_DIR = ROOT_DIR.path("misaghestan")
...
MIGRATION_MODULES = {"sites": "misaghestan.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "misaghestan.utils.context_processors.settings_context",
            ],
        },
    }
]
...
ADMINS = [("""Misagh Lotfi""", "misaghlb@live.com")]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "misaghestan.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "misaghestan.users.adapters.SocialAccountAdapter"
